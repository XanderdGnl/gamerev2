                ...
                <div class="card-body text-white">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="rating" name="rating" class="form-control" min="1" max="5" step="0.1" value="<?php echo htmlspecialchars($rating); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="post_title" class="form-label">Post Title</label>
                            <input type="text" name="post_title" id="post_title" class="form-control" value="<?php echo htmlspecialchars($post_title); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="content" class="form-label">Content</label>
                            <textarea name="content" id="content" rows="6" class="form-control" required><?php echo htmlspecialchars($content); ?></textarea>
                        </div>
